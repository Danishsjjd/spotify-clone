...
let songs = [
    { songName: "Ballpoint - Walk Slowly", filePath: "songs/1.mp3", cover: "img/covers/1.jpg", time: "2:17" },
    { songName: "JONY, HammAli & Navai - Без тебя я не я", filePath: "songs/2.mp3", cover: "img/covers/2.jpg", time: "3:21" },
    { songName: "UpsideDown - Wut Wut", filePath: "songs/3.mp3", cover: "img/covers/3.jpg", time: "2:19" },
    { songName: "DJ Trac - Shaab _Justice League", filePath: "songs/4.mp3", cover: "img/covers/4.jpg", time: "2:16" },
    { songName: "Cheel _ Violet Vape", filePath: "songs/5.mp3", cover: "img/covers/5.jpg", time: "3:01" },
];
...
Array.from(document.getElementsByClassName("danish")).forEach((element, index) => {
    element.addEventListener("click", (d, i = index) => {
        songindex = i;
        audio.src = `songs/${songindex + 1}.mp3`
        playhere();
        btitle.innerHTML = songs[i].songName;
        danish();
